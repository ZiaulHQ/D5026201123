...
<head>
    ...
    <style>
        body {
            font-size: medium;
            background-image: url("tile_backgroundjs.png");
        }
...
<body>
    ...
    <div class="container pb-5" style="background-color: aliceblue;">
        ...
        <form method="GET" action="">
            ...
            <script>
                function upper() {
                    let a = document.getElementById("kalimat-anda").value;
                    console.log(a.toUpperCase());
                    document.getElementById("hasil-upper").innerHTML = a.toUpperCase();
                }
                function lower() {
                    let b = document.getElementById("kalimat-anda").value;
                    console.log(b.toLowerCase());
                    document.getElementById("hasil-lower").innerHTML = b.toLowerCase();
                }
            </script>
            <div class="container pl-0">
                <input type="button" class="btn btn-danger" id="uppercase" value="UpperCase" onclick="upper();">
            </div>
            <br>
            ...
            <br>
            <div class="container pl-0">
                <input type="button" class="btn btn-warning" id="lowercase" value="LowerCase" onclick="lower();">
            </div>
            <br>
            <div class="container pt-3 hasil">
